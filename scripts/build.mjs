...
await writeFile("dist/build-manifest.json",JSON.stringify({_copyright:"© 2026 Fernando Rodrigues de Jácomo — Projeto Comunitário de Milreu",version:"0.11.3",builtAt:new Date().toISOString(),memoriesChecksum:`sha256:${hash}`,collectionsChecksum:`sha256:${collectionsHash}`,indexChecksum:`sha256:${indexHash}`,carouselChecksum:`sha256:${carouselHash}`,channelsChecksum:`sha256:${channelsHash}`,structuredChecksum:`sha256:${structuredHash}`,mode:"editorial-preview-noindex"},null,2)+"\n");
