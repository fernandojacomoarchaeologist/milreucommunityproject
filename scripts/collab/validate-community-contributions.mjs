...
if(pkg.version!=="0.30.0")throw new Error("Versão 08E incorreta.");
if(model.version!=="0.30.0")throw new Error("Modelo 08E desatualizado.");
...
if(model.limits.maxFiles!==5||model.limits.maxFileSizeBytes!==10485760){
