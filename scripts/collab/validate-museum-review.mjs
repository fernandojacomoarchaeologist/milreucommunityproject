...
if(pkg.version!=="0.17.0")throw new Error("Versão 08F incorreta.");
if(model.version!=="0.17.0"||model.recordCount!==31)throw new Error("Modelo de revisão incorreto.");
...
if(impact.currentPackage!=="08F"||impact.version!=="0.17.0")throw new Error("Registo de impacto desatualizado.");
...
if(modules.some(item=>item.status!=="active"))throw new Error("08F deveria fechar os módulos registados.");
