...
if(pkg.version!=="0.18.0")throw new Error("Versão 08F incorreta.");
if(model.version!=="0.18.0"||model.recordCount!==31)throw new Error("Modelo de revisão incorreto.");
...
if(impact.currentPackage!=="08G"||impact.version!=="0.18.0")throw new Error("Registo de impacto desatualizado.");
