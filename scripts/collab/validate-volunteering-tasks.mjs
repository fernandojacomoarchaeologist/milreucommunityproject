...
if(pkg.version!=="0.38.0")throw new Error("Versão 08C incorreta.");
if(model.version!=="0.38.0"||model.categories.length<12)throw new Error("Modelo de tarefas incompleto.");
