...
if(pkg.version!=="0.38.1")throw new Error("Versão 08G incorreta.");
if(profile.version!=="0.38.1"||profileExample.version!=="0.38.1")throw new Error("Perfil de implantação desatualizado.");
if(readiness.version!=="0.38.1"||model.version!=="0.38.1")throw new Error("Modelo/readiness 08G desatualizado.");
...
if(impact.currentPackage!=="10C.1"||impact.version!=="0.38.1")throw new Error("Registo de impacto 08G desatualizado.");
