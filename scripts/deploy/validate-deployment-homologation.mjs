...
if(pkg.version!=="0.21.0")throw new Error("Versão 08G incorreta.");
if(profile.version!=="0.21.0"||profileExample.version!=="0.21.0")throw new Error("Perfil de implantação desatualizado.");
if(readiness.version!=="0.21.0"||model.version!=="0.21.0")throw new Error("Modelo/readiness 08G desatualizado.");
...
if(impact.currentPackage!=="08J"||impact.version!=="0.21.0")throw new Error("Registo de impacto 08G desatualizado.");
