...
if(pkg.version!=="0.37.1")throw new Error("Versão 08H incorreta.");
if(model.version!=="0.37.1"||templates.version!=="0.37.1"||runtime.version!=="0.37.1")throw new Error("Contratos 08H desatualizados.");
...
if(impact.currentPackage!=="10B.1"||impact.version!=="0.37.1")throw new Error("Registo de impacto desatualizado.");
