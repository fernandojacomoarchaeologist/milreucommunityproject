...
if(pkg.version!=="0.30.0")throw new Error("Versão 08H incorreta.");
if(model.version!=="0.30.0"||templates.version!=="0.30.0"||runtime.version!=="0.30.0")throw new Error("Contratos 08H desatualizados.");
...
if(impact.currentPackage!=="09B"||impact.version!=="0.30.0")throw new Error("Registo de impacto desatualizado.");
