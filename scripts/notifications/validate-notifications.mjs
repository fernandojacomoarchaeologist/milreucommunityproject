...
if(pkg.version!=="0.32.0")throw new Error("Versão 08H incorreta.");
if(model.version!=="0.32.0"||templates.version!=="0.32.0"||runtime.version!=="0.32.0")throw new Error("Contratos 08H desatualizados.");
