...
const report={version:"0.38.1",operationsCandidate:rd.operationsCandidate,publicTransparency:rd.publicTransparency,continuity:rd.continuity,productionApproval:"blocked",activeOperatingCycles:0,gates:gates.map(c=>({code:c,status:"blocked",blocking:true}))};
