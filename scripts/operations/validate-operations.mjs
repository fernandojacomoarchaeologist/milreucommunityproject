...
if(pkg.version!=="0.33.0")throw new Error("Versão 08I incorreta.");
for(const item of [model,retention,runtime,readiness,impact]){
  if(item.version!=="0.33.0")throw new Error("Contrato 08I desatualizado.");
}
if(impact.currentPackage!=="09C.1")throw new Error("Registo de impacto não aponta para 09C.");
...
if(roles.permissions.length!==152)throw new Error("O catálogo acumulado deve conter 117 permissões.");
