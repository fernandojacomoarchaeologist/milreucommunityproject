...
if(pkg.version!=="0.30.0")throw new Error("Versão 08I incorreta.");
for(const item of [model,retention,runtime,readiness,impact]){
  if(item.version!=="0.30.0")throw new Error("Contrato 08I desatualizado.");
}
if(impact.currentPackage!=="09B")throw new Error("Registo de impacto não aponta para 09B.");
