...
if (pub.version !== "0.23.0") fail("versão do modelo público incorreta.");
...
if (paths.version !== "0.23.0") fail("versão do modelo de participação incorreta.");
...
if (roles.permissions.length !== 140) fail(`esperadas 140 permissões, encontradas ${roles.permissions.length}.`);
