...
const technicalChecks=[
 {code:"version",passed:pkg.version==="0.22.0",detail:pkg.version},
 {code:"modules",passed:modules.modules.length===23&&modules.modules.every(item=>item.status==="active"),detail:`${modules.modules.length} ativos`},
 {code:"permissions",passed:roles.permissions.length===127,detail:`${roles.permissions.length} preservadas`},
