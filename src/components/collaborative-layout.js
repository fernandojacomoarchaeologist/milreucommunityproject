    ...
    <div class="collab-layout">
      <aside class="collab-sidebar">
        ...
        ${(
          ...
          ${hasPermission(context,"homologation.view")?`<a href="#/area-colaborativa/gestao/homologacao">Implantação e homologação</a><a href="#/area-colaborativa/gestao/homologacao/release-candidate">Release candidate</a>`:""}
