...
// 09B: estado temporário dos idiomas. As strings de UI estão traduzidas, mas o CONTEÚDO
// (portal, memórias, carrossel) só existe revisto em pt-PT. Até à revisão humana (09D),
// só pt-PT é selecionável; EN/ES/FR aparecem como "em preparação", sem fallback silencioso
...
export const isLocaleSelectable = (code) => Boolean(languageAvailability[code]?.selectorEnabled);
...
const ui = {
  "pt-PT": {
    ...
    knowledge:"Experiência Proteus", about:"Sobre", participate:"Participar", collaborativeArea:"Área Colaborativa", explore:"Explorar",
  ...
  en: {
    ...
    knowledge:"Proteus Experience", about:"About", participate:"Participate", collaborativeArea:"Collaborative Area", explore:"Explore",
  ...
  es: {
    ...
    knowledge:"Experiencia Proteus", about:"Sobre el proyecto", participate:"Participar", collaborativeArea:"Área colaborativa", explore:"Explorar",
  ...
  fr: {
    ...
    knowledge:"Expérience Proteus", about:"À propos", participate:"Participer", collaborativeArea:"Espace collaboratif", explore:"Explorer",
