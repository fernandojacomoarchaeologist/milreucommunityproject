...
const ui = {
  "pt-PT": {
    ...
    learnMore:"Conhecer", status:"Estado", structuredKnowledge:"Dados e conhecimento estruturado",
  ...
  en: {
    ...
    status:"Status", structuredKnowledge:"Structured data and knowledge", participationWays:"Ways to participate",
  ...
  es: {
    ...
    status:"Estado", structuredKnowledge:"Datos y conocimiento estructurado", participationWays:"Formas de participar",
  ...
  fr: {
    ...
    status:"État", structuredKnowledge:"Données et connaissances structurées", participationWays:"Participer",
