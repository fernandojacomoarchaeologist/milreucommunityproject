...
test("catálogo tem 149 permissões e as 9 novas",()=>{assert.equal(roles.permissions.length,152);for(const p of ["governance.decide","support.submit","moderation.manage","impact.manage"])assert.ok(roles.permissions.includes(p));});
