...
test("biblioteca possui recursos de contexto e revisão",()=>{assert.ok(library.resources.length>=9);assert.ok(library.resources.some(x=>x.code==="context-recovery"));assert.ok(library.resources.some(x=>x.code==="museum-review-manual"));});
