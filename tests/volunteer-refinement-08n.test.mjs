...
test("08N não cria módulos nem permissões",()=>{assert.equal(model.newPermissionsExpected,0);assert.equal(model.newModulesExpected,0);assert.equal(roles.permissions.length,152);assert.equal(modules.modules.length,26);});
